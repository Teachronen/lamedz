...
# =========================================================
# רישום המודל Mission למסך הניהול
# =========================================================
# המודל הזה יאפשר ל-admin:
# - ליצור משימות חדשות
# - לערוך שם ותאריך
# - לסמן איזו משימה פעילה כרגע
# =========================================================
...
class MissionAdmin(admin.ModelAdmin):
    ...
    # list_display
    # -----------------------------------------------------
    # אילו עמודות יוצגו ברשימת המשימות ב-admin.
    # -----------------------------------------------------
    list_display = (
        "title",
        "mission_date",
    ...
    # list_filter
    # -----------------------------------------------------
    # מאפשר לסנן לפי משימות פעילות ותאריך.
    # -----------------------------------------------------
    list_filter = (
        "is_active",
        "mission_date",
    ...
    # ordering
    # -----------------------------------------------------
    # נציג קודם את המשימות החדשות יותר.
    # -----------------------------------------------------
